        ...
        <div className="flex flex-col bg-white">
            ...
            <div className="flex gap-4 p-6 max-sm:p-3 items-center">
                <img
                    src={avatar}
                    alt="User Avatar"
                    className="rounded-full w-14 h-14 object-contain bg-gray-800 max-sm:rounded-md max-sm:w-12 max-sm:h-12"
                />
                <input
                    type="text"
                    name=""
          ...
          placeholder:text-sm bg-body-base-color/15 placeholder:px-5 py-3 rounded-full max-sm:rounded-md"
                />
            ...
            <div className="flex my-3 justify-center max-sm:hidden">
              ...
              font-semibold text-sm text-body-base-color"
                        >
                            {item.icon} {item.name}
                        </li>
                    ))}
